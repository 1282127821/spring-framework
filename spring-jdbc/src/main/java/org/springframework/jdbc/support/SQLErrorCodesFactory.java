...
public class SQLErrorCodesFactory {
    ...
    public SQLErrorCodes getErrorCodes(DataSource dataSource) {
        ...
        synchronized (this.dataSourceCache) {
            ...
            if (sec != null) {
                if (logger.isDebugEnabled()) {
                    logger.debug("SQLErrorCodes found in cache for DataSource [" + dataSource.getClass().getName() + '@'
        ...
        if (customTranslator != null) {
            if (dbCodes.getCustomSqlExceptionTranslator() != null) {
                logger.warn("Overriding already defined custom translator '"
                        + dbCodes.getCustomSqlExceptionTranslator().getClass().getSimpleName() + " with '"
