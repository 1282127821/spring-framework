...
public class CallMetaDataContext {
    ...
    protected List<SqlParameter> reconcileParameters(List<SqlParameter> parameters) {
        ...
        for (String limitedParamName : this.limitedInParameterNames) {
            limitedInParamNamesMap.put(this.metaDataProvider.parameterNameToUse(limitedParamName).toLowerCase(),
                    limitedParamName);
        }
            ...
            if (declaredParams.containsKey(paramNameToCheck)
                ...
                if (meta.getParameterType() == DatabaseMetaData.procedureColumnReturn) {
                    if (!isFunction() && !isReturnValueRequired()
                        ...
                        String returnNameToUse = (StringUtils.hasLength(meta.getParameterName()) ? paramNameToUse
