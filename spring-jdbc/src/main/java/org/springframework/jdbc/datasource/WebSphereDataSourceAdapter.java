...
public class WebSphereDataSourceAdapter extends IsolationLevelDataSourceAdapter {
    ...
    protected Connection doGetConnection(String username, String password) throws SQLException {
        ...
        Object connSpec =
                createConnectionSpec(getCurrentIsolationLevel(), getCurrentReadOnlyFlag(), username, password);
        ...
        return (Connection) ReflectionUtils.invokeJdbcMethod(this.wsDataSourceGetConnectionMethod,
                getTargetDataSource(), connSpec);
    }
     ...
     * @see com.ibm.websphere.rsadapter.JDBCConnectionSpec
     */
    protected Object createConnectionSpec(Integer isolationLevel, Boolean readOnlyFlag, String username,
