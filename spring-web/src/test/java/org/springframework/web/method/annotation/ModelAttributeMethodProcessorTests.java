...
public class ModelAttributeMethodProcessorTests {
    ...
    public void setUp() throws Exception {
        ...
        Method method = ModelAttributeHandler.class.getDeclaredMethod("modelAttribute", TestBean.class, Errors.class,
                int.class, TestBean.class, TestBean.class);
    ...
    public void resolveArgumentOrdering() throws Exception {
        ...
        assertSame("Resolved attribute should be updated to be last in the order", testBean,
                mavContainer.getModel().values().toArray()[1]);
        assertSame("BindingResult of resolved attribute should be last in the order", dataBinder.getBindingResult(),
    ...
    private static class ModelAttributeHandler {
        ...
        public void modelAttribute(@ModelAttribute("attrName") @Valid TestBean annotatedAttr, Errors errors, int intArg,
                @ModelAttribute TestBean defaultNameAttr, TestBean notAnnotatedAttr) {}
    }
