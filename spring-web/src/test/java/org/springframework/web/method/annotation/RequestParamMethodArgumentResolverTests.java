...
public class RequestParamMethodArgumentResolverTests {
    ...
    public void setUp() throws Exception {
        ...
        Method method = getClass().getMethod("params", String.class, String[].class, Map.class, MultipartFile.class,
                List.class, MultipartFile[].class, Part.class, List.class, Part[].class, Map.class, String.class,
                MultipartFile.class, List.class, Part.class, MultipartFile.class, String.class, String.class,
                Optional.class);
