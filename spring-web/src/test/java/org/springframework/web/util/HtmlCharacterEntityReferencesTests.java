...
public class HtmlCharacterEntityReferencesTests {
    ...
    public void testSupportsAllCharacterEntityReferencesDefinedByHtml() {
        ...
        assertEquals("The HTML 4.0 Standard defines 252+1 entity references so do entityReferences", 252 + 1,
                entityReferences.getSupportedReferenceCount());

        assertEquals("Invalid entity reference names should not be convertible", (char) -1,
