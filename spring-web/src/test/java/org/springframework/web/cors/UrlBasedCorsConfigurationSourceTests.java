...
public class UrlBasedCorsConfigurationSourceTests {
    ...
    @Test
    public void empty() {
        assertNull(this.configSource
                .getCorsConfiguration(new MockHttpServletRequest(HttpMethod.GET.name(), "/bar/test.html")));
    }
    ...
    public void registerAndMatch() {
        ...
        assertNull(this.configSource
                .getCorsConfiguration(new MockHttpServletRequest(HttpMethod.GET.name(), "/foo/test.html")));
        assertEquals(config, this.configSource
                .getCorsConfiguration(new MockHttpServletRequest(HttpMethod.GET.name(), "/bar/test.html")));
    }
