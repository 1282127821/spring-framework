...
public abstract class MultipartResolutionDelegate {
    ...
    static {
        try {
            servletPartClass =
                    ClassUtils.forName("javax.servlet.http.Part", MultipartResolutionDelegate.class.getClassLoader());
    ...
    public static boolean isMultipartArgument(MethodParameter parameter) {
        ...
        return (MultipartFile.class == paramType || isMultipartFileCollection(parameter)
                || isMultipartFileArray(parameter) || (servletPartClass != null
                        && (servletPartClass == paramType || isPartCollection(parameter) || isPartArray(parameter))));
    }
