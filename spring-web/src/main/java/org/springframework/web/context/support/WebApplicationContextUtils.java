...
public abstract class WebApplicationContextUtils {
     ...
     */
    public static void registerEnvironmentBeans(ConfigurableListableBeanFactory bf, ServletContext servletContext,
    ...
    public static void initServletPropertySources(MutablePropertySources propertySources, ServletContext servletContext,
        ...
        if (servletContext != null
                ...
                && propertySources.get(
                        StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME) instanceof StubPropertySource) {
        ...
        if (servletConfig != null
                ...
                && propertySources.get(
                        StandardServletEnvironment.SERVLET_CONFIG_PROPERTY_SOURCE_NAME) instanceof StubPropertySource) {
