...
public abstract class WebUtils {
    ...
    public static boolean isSameOrigin(HttpRequest request) {
        ...
        if (request instanceof ServletServerHttpRequest) {
            ...
            urlBuilder =
                    new UriComponentsBuilder().scheme(servletRequest.getScheme()).host(servletRequest.getServerName())
                            .port(servletRequest.getServerPort()).adaptFromForwardedHeaders(request.getHeaders());
        } else {
