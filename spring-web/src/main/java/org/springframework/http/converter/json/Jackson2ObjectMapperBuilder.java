...
public class Jackson2ObjectMapperBuilder {
    ...
    private void registerWellKnownModulesIfAvailable(ObjectMapper objectMapper) {
        ...
        if (ClassUtils.isPresent("java.nio.file.Path", this.moduleClassLoader)) {
            try {
                Class<? extends Module> jdk7Module = (Class<? extends Module>) ClassUtils
                        .forName("com.fasterxml.jackson.datatype.jdk7.Jdk7Module", this.moduleClassLoader);
        ...
        if (ClassUtils.isPresent("java.time.LocalDate", this.moduleClassLoader)) {
            try {
                ...
                try {
                    Class<? extends Module> jsr310Module = (Class<? extends Module>) ClassUtils
                            .forName("com.fasterxml.jackson.datatype.jsr310.JSR310Module", this.moduleClassLoader);
