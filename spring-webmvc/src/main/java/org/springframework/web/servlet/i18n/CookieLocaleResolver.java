                ...
                try {
                    ...
                    if (request.getAttribute(WebUtils.ERROR_EXCEPTION_ATTRIBUTE) != null) {
                        ...
                        if (logger.isDebugEnabled()) {
                            logger.debug("Ignoring invalid locale cookie '" + getCookieName() + "' with value [" + value
                                    + "] due to error dispatch: " + ex.getMessage());
                        }
                    } else {
                        throw new IllegalStateException("Invalid locale cookie '" + getCookieName() + "' with value ["
                                + value + "]: " + ex.getMessage());
                    }
                }
                if (logger.isDebugEnabled()) {
