...
public class FreeMarkerView extends AbstractTemplateView {
    ...
    protected FreeMarkerConfig autodetectConfiguration() throws BeansException {
        try {
            return BeanFactoryUtils.beanOfTypeIncludingAncestors(getApplicationContext(), FreeMarkerConfig.class, true,
                    false);
    ...
    public boolean checkResource(Locale locale) throws Exception {
        ...
        try {
            ...
            throw new ApplicationContextException("Failed to parse FreeMarker template for URL [" + url + "]", ex);
