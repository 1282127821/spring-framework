...
public class MultiActionControllerTests {
    ...
    private void doTestCustomizedInternalPathMethodNameResolver(String in, String prefix, String suffix,
    ...
    public static class TestMaController extends MultiActionController {
        ...
        public ModelAndView commandNoSession(HttpServletRequest request, HttpServletResponse response,
                TestBean command) {
