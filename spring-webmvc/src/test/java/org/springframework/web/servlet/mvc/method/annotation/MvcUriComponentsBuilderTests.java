...
public class MvcUriComponentsBuilderTests {
    ...
    public void testFromMethodNamePathVariable() throws Exception {
        UriComponents uriComponents =
                fromMethodName(ControllerWithMethods.class, "methodWithPathVariable", new Object[] {"1"}).build();
    ...
    public void testFromMethodNameTypeLevelPathVariable() throws Exception {
        ...
        UriComponents uriComponents =
                fromMethodName(PersonsAddressesController.class, "getAddressesForCountry", "DE").buildAndExpand("1");
    ...
    public void testFromMethodNameWithCustomBaseUrlViaStaticCall() throws Exception {
        UriComponentsBuilder builder = UriComponentsBuilder.fromUriString("http://example.org:9090/base");
        UriComponents uriComponents =
                fromMethodName(builder, ControllerWithMethods.class, "methodWithPathVariable", new Object[] {"1"})
                        .build();
    ...
    public void testFromMethodNameWithCustomBaseUrlViaInstance() throws Exception {
        ...
        UriComponents uriComponents = mvcBuilder
                .withMethodName(ControllerWithMethods.class, "methodWithPathVariable", new Object[] {"1"}).build();
    ...
    public void testFromMethodCallWithTypeLevelUriVars() {
        UriComponents uriComponents =
                fromMethodCall(on(PersonsAddressesController.class).getAddressesForCountry("DE")).buildAndExpand(15);
