...
public class ServletModelAttributeMethodProcessorTests {
    ...
    public void createAttributeUriTemplateVar() throws Exception {
        ...
        TestBean testBean = (TestBean) this.processor.resolveArgument(this.testBeanModelAttr, this.mavContainer,
    ...
    public void createAttributeUriTemplateVarCannotConvert() throws Exception {
        ...
        TestBeanWithoutStringConstructor testBean = (TestBeanWithoutStringConstructor) this.processor.resolveArgument(
    ...
    public void createAttributeUriTemplateVarWithOptional() throws Exception {
        ...
        Optional<TestBean> testBean =
                (Optional<TestBean>) this.processor.resolveArgument(this.testBeanWithOptionalModelAttr,
    ...
    public void attributesAsNullValues() throws Exception {
        ...
        assertNull(this.processor.resolveArgument(this.testBeanModelAttr, this.mavContainer, this.webRequest,
                this.binderFactory));

        assertNull(this.processor.resolveArgument(this.testBeanWithoutStringConstructorModelAttr, this.mavContainer,
                this.webRequest, this.binderFactory));
