...
public class NashornScriptTemplateTests {
    ...
    public void renderTemplate() throws Exception {
        ...
        MockHttpServletResponse response =
                renderViewWithModel("org/springframework/web/servlet/view/script/nashorn/template.html", model,
                        ScriptTemplatingConfiguration.class);
    ...
    public void renderTemplateWithUrl() throws Exception {
        MockHttpServletResponse response =
                renderViewWithModel("org/springframework/web/servlet/view/script/nashorn/template.html", null,
                        ScriptTemplatingWithUrlConfiguration.class);
        assertEquals(
                "<html><head><title>Check url parameter</title></head><body><p>org/springframework/web/servlet/view/script/nashorn/template.html</p></body></html>",
                response.getContentAsString());
    }

    private MockHttpServletResponse renderViewWithModel(String viewUrl, Map<String, Object> model,
