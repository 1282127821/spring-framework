...
public class MatrixVariablesMapMethodArgumentResolverTests {
    ...
    public void setUp() throws Exception {
        ...
        Method method = getClass().getMethod("handle", String.class, Map.class, MultiValueMap.class,
                MultiValueMap.class, Map.class);
    ...
    public void resolveArgument() throws Exception {
        ...
        Map<String, String> map = (Map<String, String>) this.resolver.resolveArgument(this.paramMap, this.mavContainer,
        ...
        MultiValueMap<String, String> multivalueMap = (MultiValueMap<String, String>) this.resolver
                .resolveArgument(this.paramMultivalueMap, this.mavContainer, this.webRequest, null);
    ...
    public void resolveArgumentPathVariable() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        Map<String, String> mapForPathVar = (Map<String, String>) this.resolver.resolveArgument(this.paramMapForPathVar,
                this.mavContainer, this.webRequest, null);

        assertEquals(Arrays.asList("red", "purple"), mapForPathVar.get("colors"));

        @SuppressWarnings("unchecked")
        Map<String, String> mapAll = (Map<String, String>) this.resolver.resolveArgument(this.paramMap,
                this.mavContainer, this.webRequest, null);
    ...
    public void resolveArgumentNoMatch() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        Map<String, String> map = (Map<String, String>) this.resolver.resolveArgument(this.paramMapForPathVar,
                this.mavContainer, this.webRequest, null);
    ...
    private MultiValueMap<String, String> getMatrixVariables(String pathVarName) {
        Map<String, MultiValueMap<String, String>> matrixVariables =
                (Map<String, MultiValueMap<String, String>>) this.request
