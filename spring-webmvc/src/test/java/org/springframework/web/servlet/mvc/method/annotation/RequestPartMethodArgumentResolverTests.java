...
public class RequestPartMethodArgumentResolverTests {
    ...
    public void setUp() throws Exception {
        Method method = getClass().getMethod("handle", SimpleBean.class, SimpleBean.class, SimpleBean.class,
                MultipartFile.class, List.class, MultipartFile[].class, Integer.TYPE, MultipartFile.class, Part.class,
                List.class, Part[].class, MultipartFile.class, Optional.class, Optional.class, Optional.class);
        ...
        resolver = new RequestPartMethodArgumentResolver(
    ...
    public void resolveOptionalRequestPart() throws Exception {
        ...
        Object actualValue =
                resolver.resolveArgument(optionalRequestPart, mavContainer, webRequest, new ValidatingBinderFactory());
    ...
    public void resolveOptionalRequestPartNotPresent() throws Exception {
        given(messageConverter.canRead(SimpleBean.class, MediaType.TEXT_PLAIN)).willReturn(true);
        given(messageConverter.read(eq(SimpleBean.class), isA(RequestPartServletServerHttpRequest.class)))
                .willReturn(null);
    ...
    private void testResolveArgument(SimpleBean argValue, MethodParameter parameter) throws Exception {
        ...
        Object actualValue =
                resolver.resolveArgument(parameter, mavContainer, webRequest, new ValidatingBinderFactory());
