...
public class HttpEntityMethodProcessorMockTests {
    ...
    public void supportsReturnType() {
        ...
        assertTrue("Custom HttpEntity subclass not supported",
                processor.supportsReturnType(returnTypeHttpEntitySubclass));
    ...
    public void resolveArgumentRequestEntity() throws Exception {
        ...
        assertEquals("Invalid url", new URI("http", null, "www.example.com", -1, "/path", null, null),
    ...
    public void handleReturnValueWithResponseBodyAdvice() throws Exception {
        ...
        HttpEntityMethodProcessor processor = new HttpEntityMethodProcessor(Collections.singletonList(messageConverter),
                null, Collections.singletonList(advice));
    ...
    public void handleReturnTypeNotModified() throws Exception {
        ...
        ResponseEntity<String> returnValue =
                new ResponseEntity<String>("body", responseHeaders, HttpStatus.NOT_MODIFIED);
