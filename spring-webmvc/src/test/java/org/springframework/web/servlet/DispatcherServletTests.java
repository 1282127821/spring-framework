...
public class DispatcherServletTests {
    ...
    public void configuredDispatcherServlets() {
        ...
        assertTrue("Correct attribute", (FrameworkServlet.SERVLET_CONTEXT_PREFIX + "simple")
        ...
        assertTrue("Correct attribute", (FrameworkServlet.SERVLET_CONTEXT_PREFIX + "complex")
