...
public class ServletAnnotationControllerTests {
    ...
    public void emptyRequestMapping() throws Exception {
        ...
        MockHttpServletRequest request =
                new MockHttpServletRequest("GET", "/servletannotationcontrollertests.controllerwithemptymapping");
        MockHttpServletResponse response = new MockHttpServletResponse();
        servlet.service(request, response);
        assertEquals("test", response.getContentAsString());
    }
        ...
        servlet = new DispatcherServlet() {
            ...
            protected WebApplicationContext createWebApplicationContext(WebApplicationContext parent) {
                ...
                wac.registerBeanDefinition("controller",
                        new RootBeanDefinition(DefaultExpressionValueParamController.class));
    ...
    public void sessionAttributeExposureWithInterface() throws Exception {
        ...
        DispatcherServlet servlet = new DispatcherServlet() {
            ...
            protected WebApplicationContext createWebApplicationContext(WebApplicationContext parent) {
                GenericWebApplicationContext wac = new GenericWebApplicationContext();
                wac.registerBeanDefinition("controller",
                        new RootBeanDefinition(MySessionAttributesControllerImpl.class));
                wac.registerBeanDefinition("viewResolver", new RootBeanDefinition(ModelExposingViewResolver.class));
                DefaultAdvisorAutoProxyCreator autoProxyCreator = new DefaultAdvisorAutoProxyCreator();
                autoProxyCreator.setBeanFactory(wac.getBeanFactory());
                wac.getBeanFactory().addBeanPostProcessor(autoProxyCreator);
    ...
    public void responseBodyArgMismatch() throws ServletException, IOException {
        ...
        DispatcherServlet servlet = new DispatcherServlet() {
            ...
            protected WebApplicationContext createWebApplicationContext(WebApplicationContext parent) {
                GenericWebApplicationContext wac = new GenericWebApplicationContext();
                wac.registerBeanDefinition("controller",
                        new RootBeanDefinition(RequestBodyArgMismatchController.class));
    ...
    public void parameterCsvAsIntegerSetWithCustomSeparator() throws Exception {
        servlet = new DispatcherServlet() {
            ...
            protected WebApplicationContext createWebApplicationContext(WebApplicationContext parent) {
                ...
                RootBeanDefinition wbiDef = new RootBeanDefinition(ConfigurableWebBindingInitializer.class);
                wbiDef.getPropertyValues().add("conversionService", csDef);
                wbiDef.getPropertyValues().add("propertyEditorRegistrars",
                        new RootBeanDefinition(ListEditorRegistrar.class));
                RootBeanDefinition adapterDef = new RootBeanDefinition(AnnotationMethodHandlerAdapter.class);
                adapterDef.getPropertyValues().add("webBindingInitializer", wbiDef);
                wac.registerBeanDefinition("handlerAdapter", adapterDef);
                wac.refresh();
    ...
    private static class MyAdaptedController {
        ...
        public void myHandle(@RequestParam("param1") String p1, @RequestParam("param2") int p2,
                @RequestHeader("header1") long h1, @CookieValue("cookie1") Cookie c1, HttpServletResponse response)
                throws IOException {
    ...
    private static class MyCommandProvidingFormController<T, TB, TB2> extends MyFormController {
        ...
        private ValidTestBean createTestBean(@RequestParam T defaultName, Map<String, Object> model,
        ...
        @Override
        @RequestMapping("/myPath.do")
        public String myHandle(@ModelAttribute("myCommand") @Validated(MyGroup.class) TestBean tb, BindingResult errors,
                ModelMap model) {
    ...
    private static class MyBinderInitializingCommandProvidingFormController extends MyCommandProvidingFormController {
        ...
        @Override
        @RequestMapping("/myPath.do")
        public String myHandle(@ModelAttribute("myCommand") @MyValid TestBean tb, BindingResult errors,
                ModelMap model) {
    ...
    public static class CsvController {
        ...
        public void processCsv(@RequestParam("content") Set<Integer> content, HttpServletResponse response)
                throws IOException {
