...
public class RequestResponseBodyMethodProcessorTests {
    ...
    public void setUp() throws Exception {
        ...
        Method method =
                getClass().getDeclaredMethod("handle", List.class, SimpleBean.class, MultiValueMap.class, String.class);
    ...
    public void resolveArgumentParameterizedType() throws Exception {
        ...
        List<SimpleBean> result =
                (List<SimpleBean>) processor.resolveArgument(paramGenericList, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentRawTypeFromParameterizedType() throws Exception {
        ...
        MultiValueMap<String, String> result = (MultiValueMap<String, String>) processor
                .resolveArgument(paramMultiValueMap, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentClassJson() throws Exception {
        ...
        SimpleBean result =
                (SimpleBean) processor.resolveArgument(paramSimpleBean, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentClassString() throws Exception {
        ...
        String result = (String) processor.resolveArgument(paramString, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentTypeVariable() throws Exception {
        ...
        SimpleBean result =
                (SimpleBean) processor.resolveArgument(methodParam, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentWithJacksonJsonView() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        JacksonViewBean result = (JacksonViewBean) processor.resolveArgument(methodParameter, this.mavContainer,
    ...
    public void resolveArgumentWithJacksonJsonViewAndXmlMessageConverter() throws Exception {
        String content =
                "<root><withView1>with</withView1><withView2>with</withView2><withoutView>without</withoutView></root>";
        this.servletRequest.setContent(content.getBytes("UTF-8"));
    ...
    private void assertContentDisposition(RequestResponseBodyMethodProcessor processor,
        ...
        if (expectContentDisposition) {
            assertEquals("Expected 'Content-Disposition' header. Use case: '" + comment + "'", "inline;filename=f.txt",
                    header);
        } else {
