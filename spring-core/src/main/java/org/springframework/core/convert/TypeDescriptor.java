...
public class TypeDescriptor implements Serializable {
    ...
    private static final boolean streamAvailable =
            ClassUtils.isPresent("java.util.stream.Stream", TypeDescriptor.class.getClassLoader());
    ...
    public TypeDescriptor(MethodParameter methodParameter) {
        ...
        this.annotations =
                (methodParameter.getParameterIndex() == -1 ? nullSafeAnnotations(methodParameter.getMethodAnnotations())
