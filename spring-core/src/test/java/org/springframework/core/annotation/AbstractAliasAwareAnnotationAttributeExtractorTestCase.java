...
public abstract class AbstractAliasAwareAnnotationAttributeExtractorTestCase {
    ...
    private void assertGetAttributeValueForImplicitAliases(Class<?> clazz, String expected) throws Exception {
        ...
        AnnotationAttributeExtractor<?> extractor =
                createExtractorFor(clazz, expected, ImplicitAliasesContextConfig.class);
    ...
    protected abstract AnnotationAttributeExtractor<?> createExtractorFor(Class<?> clazz, String expected,
