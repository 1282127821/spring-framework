    ...
    public void setRequiredProperties_andValidateRequiredProperties() {
        ...
        try {
            ...
            assertThat(ex.getMessage(), equalTo(
                    "The following properties were declared as required " + "but could not be resolved: [foo, bar]"));
        }
    ...
    public void resolveNestedPropertyPlaceholders() {
        ...
        try {
            ...
            assertThat(ex.getMessage(),
                    containsString("Could not resolve placeholder 'bogus' in string value \"${p1}:${p2}:${bogus}\""));
        }
