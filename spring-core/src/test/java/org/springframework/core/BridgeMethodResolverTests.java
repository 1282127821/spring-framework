...
public class BridgeMethodResolverTests {
    ...
    public void testFindBridgedMethod() throws Exception {
        ...
        assertEquals("Unbridged method not returned directly", unbridged,
                BridgeMethodResolver.findBridgedMethod(unbridged));
    ...
    public void testCreateTypeVariableMap() throws Exception {
        ...
        typeVariableMap =
                GenericTypeResolver.getTypeVariableMap(ExtendsEnclosing.ExtendsEnclosed.ExtendsReallyDeepNow.class);
    ...
    public void testDoubleParameterization() throws Exception {
        ...
        assertEquals("foo(Integer) not resolved.", integerFoo,
                BridgeMethodResolver.findBridgedMethod(serializableBridge));
    }
    ...
    public void testSPR2583() throws Exception {
        ...
        assertFalse("Match identified incorrectly",
                BridgeMethodResolver.isBridgeMethodFor(bridgeMethod, otherMethod, MessageBroadcasterImpl.class));
        assertTrue("Match not found correctly",
                BridgeMethodResolver.isBridgeMethodFor(bridgeMethod, bridgedMethod, MessageBroadcasterImpl.class));
    ...
    public static interface ConcreteSettingsDao extends SettingsDao<ConcreteSettings, String> {
    ...
    public static interface ConvenientGenericRepository<T, ID extends Serializable> extends SimpleGenericRepository<T> {
