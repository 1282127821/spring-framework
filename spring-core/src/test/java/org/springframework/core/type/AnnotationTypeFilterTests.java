...
public class AnnotationTypeFilterTests {
    ...
    public void testInheritedAnnotationFromInterfaceDoesNotMatch() throws Exception {
        ...
        String classUnderTest =
                "org.springframework.core.type.AnnotationTypeFilterTests$SomeSubClassOfSomeComponentInterface";
        MetadataReader metadataReader = metadataReaderFactory.getMetadataReader(classUnderTest);
    ...
    @SuppressWarnings("unused")
    private static class SomeSubclassOfSomeClassMarkedWithNonInheritedAnnotation
