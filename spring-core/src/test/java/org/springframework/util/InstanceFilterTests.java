...
public class InstanceFilterTests {
    ...
    public void includesFilter() {
        InstanceFilter<String> filter = new InstanceFilter<String>(asList("First", "Second"), null, true);
        match(filter, "Second");
    ...
    public void excludesFilter() {
        InstanceFilter<String> filter = new InstanceFilter<String>(null, asList("First", "Second"), true);
    ...
    public void includesAndExcludesFilters() {
        InstanceFilter<String> filter =
                new InstanceFilter<String>(asList("foo", "Bar"), asList("First", "Second"), true);
        doNotMatch(filter, "Second");
        match(filter, "foo");
    }
    ...
    public void includesAndExcludesFiltersConflict() {
        InstanceFilter<String> filter = new InstanceFilter<String>(asList("First"), asList("First"), true);
