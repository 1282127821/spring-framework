...
public class ConcurrentReferenceHashMapTests {
    ...
    public void shouldBeFasterThanSynchronizedMap() throws Exception {
        ...
        StopWatch mapTime =
                timeMultiThreaded("SynchronizedMap", synchronizedMap, new ValueFactory<WeakReference<String>>() {
        ...
        StopWatch cacheTime = timeMultiThreaded("WeakConcurrentCache", this.map, new ValueFactory<String>() {
