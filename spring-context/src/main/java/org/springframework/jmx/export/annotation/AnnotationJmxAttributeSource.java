...
public class AnnotationJmxAttributeSource implements JmxAttributeSource, BeanFactoryAware {
    ...
    public org.springframework.jmx.export.metadata.ManagedAttribute getManagedAttribute(Method method)
        ...
        org.springframework.jmx.export.metadata.ManagedAttribute managedAttribute =
    ...
    public org.springframework.jmx.export.metadata.ManagedOperationParameter[] getManagedOperationParameters(
        ...
        Set<ManagedOperationParameter> anns = AnnotationUtils.getRepeatableAnnotations(method,
    ...
    public org.springframework.jmx.export.metadata.ManagedNotification[] getManagedNotifications(Class<?> clazz)
        ...
        Set<ManagedNotification> anns =
                AnnotationUtils.getRepeatableAnnotations(clazz, ManagedNotification.class, ManagedNotifications.class);
