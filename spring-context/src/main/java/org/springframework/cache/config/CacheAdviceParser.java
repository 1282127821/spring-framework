...
class CacheAdviceParser extends AbstractSingleBeanDefinitionParser {
    ...
    private RootBeanDefinition parseDefinitionSource(Element definition, ParserContext parserContext) {
        ...
        ManagedMap<TypedStringValue, Collection<CacheOperation>> cacheOpMap =
                new ManagedMap<TypedStringValue, Collection<CacheOperation>>();
        ...
        for (Element opElement : evictCacheMethods) {
            ...
            CacheEvictOperation.Builder builder =
                    prop.merge(opElement, parserContext.getReaderContext(), new CacheEvictOperation.Builder());
