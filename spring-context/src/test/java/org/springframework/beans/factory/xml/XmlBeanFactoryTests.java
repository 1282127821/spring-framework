...
public final class XmlBeanFactoryTests {
    ...
    private static final ClassPathResource SATISFIED_OBJECT_DEP_CONTEXT =
            classPathResource("-satisfiedObjectDepCheck.xml");
    private static final ClassPathResource SATISFIED_SIMPLE_DEP_CONTEXT =
            classPathResource("-satisfiedSimpleDepCheck.xml");
    ...
    private static final ClassPathResource UNSATISFIED_ALL_DEP_CONTEXT =
            classPathResource("-unsatisfiedAllDepCheckMissingObjects.xml");
    private static final ClassPathResource UNSATISFIED_OBJECT_DEP_CONTEXT =
            classPathResource("-unsatisfiedObjectDepCheck.xml");
    private static final ClassPathResource UNSATISFIED_SIMPLE_DEP_CONTEXT =
            classPathResource("-unsatisfiedSimpleDepCheck.xml");
    ...
    public void serializableMethodReplacerAndSuperclass() throws Exception {
        ...
        assertFalse("Lookup methods and method replacers are not meant to be serializable.",
