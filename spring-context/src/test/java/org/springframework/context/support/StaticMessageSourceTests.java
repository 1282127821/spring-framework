...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
    ...
    public void getMessageWithDefaultPassedInAndFoundInMsgCatalog() {
        ...
        assertTrue(
                ...
                sac.getMessage("message.format.example2", null, "This is a default msg if not found in MessageSource.",
                        Locale.US).equals("This is a test message in the message catalog with no args."));
    }
    ...
    protected ConfigurableApplicationContext createContext() throws Exception {
        ...
        m.put("name", "Roderick");
        parent.registerPrototype("rod", org.springframework.tests.sample.beans.TestBean.class,
                new MutablePropertyValues(m));
        m.put("name", "Albert");
        parent.registerPrototype("father", org.springframework.tests.sample.beans.TestBean.class,
                new MutablePropertyValues(m));
