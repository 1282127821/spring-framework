...
public class DataBinderTests {
    ...
    public void testConversionWithInappropriateStringEditor() {
        ...
        assertEquals("ConversionService should have invoked toString()", "Fred",
                dataBinder.convertIfNecessary(bean, String.class));
        conversionService.addConverter(new NameBeanConverter());
        assertEquals("Type converter should have been used", "[Fred]",
                dataBinder.convertIfNecessary(bean, String.class));
    }
    ...
    public void testDirectBindingToIndexedField() {
        ...
        assertEquals("NOT_ROD.org.springframework.tests.sample.beans.DerivedTestBean",
                errors.getFieldError("array[0]").getCodes()[4]);
        ...
        assertEquals("NOT_ROD.org.springframework.tests.sample.beans.TestBean",
                errors.getFieldError("map[key1]").getCodes()[4]);
    ...
    public void testDirectBindingToEmptyIndexedFieldWithRegisteredSpecificEditor() {
        ...
        assertEquals("NOT_NULL.org.springframework.tests.sample.beans.TestBean",
                errors.getFieldError("map[key0]").getCodes()[4]);
