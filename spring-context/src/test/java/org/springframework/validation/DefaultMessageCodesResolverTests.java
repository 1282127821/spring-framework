...
public class DefaultMessageCodesResolverTests {
    ...
    public void shouldResolveMessageCode() throws Exception {
        ...
        assertThat(codes, is(equalTo(new String[] {"errorCode.objectName", "errorCode"})));
    }
    ...
    public void shouldResolveFieldMessageCode() throws Exception {
        ...
        assertThat(codes, is(equalTo(new String[] {"errorCode.objectName.field", "errorCode.field",
                "errorCode.org.springframework.tests.sample.beans.TestBean", "errorCode"})));
    }
    ...
    public void shouldResolveIndexedFieldMessageCode() throws Exception {
        ...
        assertThat(codes,
                is(equalTo(new String[] {"errorCode.objectName.a.b[3].c[5].d", "errorCode.objectName.a.b[3].c.d",
                        "errorCode.objectName.a.b.c.d", "errorCode.a.b[3].c[5].d", "errorCode.a.b[3].c.d",
                        "errorCode.a.b.c.d", "errorCode.d", "errorCode.org.springframework.tests.sample.beans.TestBean",
                        "errorCode"})));
    }
    ...
    public void shouldResolveFieldMessageCodeWithPrefix() throws Exception {
        resolver.setPrefix("prefix.");
        String[] codes = resolver.resolveMessageCodes("errorCode", "objectName", "field", TestBean.class);
        assertThat(codes, is(equalTo(new String[] {"prefix.errorCode.objectName.field", "prefix.errorCode.field",
                "prefix.errorCode.org.springframework.tests.sample.beans.TestBean", "prefix.errorCode"})));
    }
    ...
    public void shouldSupportNullFieldType() throws Exception {
        ...
        assertThat(codes, is(equalTo(new String[] {"errorCode.objectName.field", "errorCode.field", "errorCode"})));
    }
    ...
    public void shouldSupportFieldPostfixFormat() throws Exception {
        resolver.setMessageCodeFormatter(Format.POSTFIX_ERROR_CODE);
        String[] codes = resolver.resolveMessageCodes("errorCode", "objectName", "field", TestBean.class);
        assertThat(codes, is(equalTo(new String[] {"objectName.field.errorCode", "field.errorCode",
                "org.springframework.tests.sample.beans.TestBean.errorCode", "errorCode"})));
    }
    ...
    public void shouldSupportCustomFormat() throws Exception {
        ...
        String[] codes = resolver.resolveMessageCodes("errorCode", "objectName");
        assertThat(codes, is(equalTo(new String[] {"CUSTOM-errorCode.objectName", "CUSTOM-errorCode"})));
    }
}
