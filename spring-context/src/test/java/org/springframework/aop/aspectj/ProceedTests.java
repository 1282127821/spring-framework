...
public final class ProceedTests {
    ...
    public void testProceedWithArgsInSameAspect() {
        ...
        assertTrue("changed value visible to next advice in chain",
                this.firstTestAspect.getLastBeforeFloatValue() > 1.9F);
    }
    ...
    public void testProceedWithArgsAcrossAspects() {
        ...
        assertEquals("changed value visible to next before advice in chain", "MALE",
                this.secondTestAspect.getLastBeforeStringValue());
        assertEquals("changed value visible to next around advice in chain", "MALE",
