...
public abstract class AbstractAopProxyTests {
    ...
    public void testUserAttributes() throws Throwable {
        ...
        MapAwareMethodInterceptor mami1 =
                new MapAwareMethodInterceptor(new HashMap<String, String>(), new HashMap<String, String>());
        Map<String, String> firstValuesToAdd = new HashMap<String, String>();
        firstValuesToAdd.put("test", "");
        MapAwareMethodInterceptor mami2 =
                new MapAwareMethodInterceptor(new HashMap<String, String>(), firstValuesToAdd);
        MapAwareMethodInterceptor mami3 =
                new MapAwareMethodInterceptor(firstValuesToAdd, new HashMap<String, String>());
