...
public class JmxUtilsTests {
    ...
    public void testAppendIdentityToObjectName() throws MalformedObjectNameException {
        ...
        assertEquals("Type key is incorrect", objectName.getKeyProperty(typeProperty),
                uniqueName.getKeyProperty("type"));
        assertEquals("Identity key is incorrect", ObjectUtils.getIdentityHexString(managedResource),
                uniqueName.getKeyProperty(JmxUtils.IDENTITY_OBJECT_NAME_KEY));
    }
