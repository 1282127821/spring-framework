...
public abstract class AbstractJmxAssemblerTests extends AbstractJmxTests {
    ...
    public void testRegisterOperations() throws Exception {
        ...
        assertEquals("Incorrect number of operations registered", getExpectedOperationCount(),
    ...
    public void testRegisterAttributes() throws Exception {
        ...
        assertNotNull(bean);
        MBeanInfo inf = getMBeanInfo();
        assertEquals("Incorrect number of attributes registered", getExpectedAttributeCount(),
    ...
    public void testAttributeHasCorrespondingOperations() throws Exception {
        ...
        assertEquals("get operation should have visibility of four", get.getDescriptor().getFieldValue("visibility"),
                new Integer(4));
        ...
        assertEquals("set operation should have visibility of four", set.getDescriptor().getFieldValue("visibility"),
                new Integer(4));
