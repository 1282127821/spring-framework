...
public final class ModelMBeanNotificationPublisherTests {
    ...
    public void testSendVanillaNotification() throws Exception {
        ...
        assertSame("The exact same Notification is not being passed through from the publisher to the mbean.",
                notification, mbean.getActualNotification());
        assertSame(
                "The 'source' property of the Notification is not being set to the ObjectName of the associated MBean.",
                objectName, mbean.getActualNotification().getSource());
    }
    ...
    public void testSendAttributeChangeNotificationWhereSourceIsNotTheManagedResource() throws Exception {
        ...
        assertSame(
                ...
                this, mbean.getActualNotification().getSource());
    }
