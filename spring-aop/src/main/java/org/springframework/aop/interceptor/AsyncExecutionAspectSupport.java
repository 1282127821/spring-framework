...
public abstract class AsyncExecutionAspectSupport implements BeanFactoryAware {
    ...
    private static final boolean completableFuturePresent = ClassUtils
            .isPresent("java.util.concurrent.CompletableFuture", AsyncExecutionInterceptor.class.getClassLoader());
    ...
    protected AsyncTaskExecutor determineAsyncExecutor(Method method) {
        ...
        if (executor == null) {
            ...
            if (StringUtils.hasLength(qualifier)) {
                ...
                executorToUse =
                        BeanFactoryAnnotationUtils.qualifiedBeanOfType(this.beanFactory, Executor.class, qualifier);
    ...
    private static class CompletableFutureDelegate {
        ...
        public static <T> Future<T> processCompletableFuture(Class<?> returnType, final Callable<T> task,
                Executor executor) {
