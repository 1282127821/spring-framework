...
class CglibAopProxy implements AopProxy, Serializable {
    ...
    protected Object createProxyClassAndInstance(Enhancer enhancer, Callback[] callbacks) {
        ...
        return (this.constructorArgs != null ? enhancer.create(this.constructorArgTypes, this.constructorArgs)
                : enhancer.create());
    }
    ...
    private Callback[] getCallbacks(Class<?> rootClass) throws Exception {
        ...
        if (exposeProxy) {
            targetInterceptor =
                    isStatic ? new StaticUnadvisedExposedInterceptor(this.advised.getTargetSource().getTarget())
