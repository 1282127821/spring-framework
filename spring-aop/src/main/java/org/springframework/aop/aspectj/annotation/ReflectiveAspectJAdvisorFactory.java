...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory {
    ...
    static {
        ...
        comparator
                .addComparator(
                        new ConvertingComparator<Method, Annotation>(
                                new InstanceComparator<Annotation>(Around.class, Before.class, After.class,
        ...
        comparator.addComparator(new ConvertingComparator<Method, String>(new Converter<Method, String>() {
            @Override
    ...
    public List<Advisor> getAdvisors(MetadataAwareAspectInstanceFactory aspectInstanceFactory) {
        ...
        // 如果寻找的增强器非空，且配置了增强延迟初始化，那么需要在首位加入同步实例化增强器
    ...
    private List<Method> getAdvisorMethods(Class<?> aspectClass) {
        ...
        ReflectionUtils.doWithMethods(aspectClass, new ReflectionUtils.MethodCallback() {
            ...
            public void doWith(Method method) throws IllegalArgumentException {
                // Exclude pointcuts 声明为 Pointcut 的方法不做处理
    ...
    /**
     * 所谓切点信息的获取其实就是指定注解的表达式信息的获取，如 @Before("test()")
    ...
    public Advice getAdvice(Method candidateAdviceMethod, AspectJExpressionPointcut expressionPointcut,
        ...
        switch (aspectJAnnotation.getAnnotationType()) {
            case AtBefore:
                springAdvice =
                        new AspectJMethodBeforeAdvice(candidateAdviceMethod, expressionPointcut, aspectInstanceFactory);
                break;
            case AtAfter:
