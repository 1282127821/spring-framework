...
public class DefaultListableBeanFactoryTests {
    ...
    public void testGetBeanWithArgsNotCreatedForFactoryBeanChecking() {
        ...
        assertEquals(1,
                lbf.getBeanNamesForType(ResolvableType.forClassWithGenerics(FactoryBean.class, Object.class)).length);
        assertEquals(0,
                lbf.getBeanNamesForType(ResolvableType.forClassWithGenerics(FactoryBean.class, String.class)).length);
    }
