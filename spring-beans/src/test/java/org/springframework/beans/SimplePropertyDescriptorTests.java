    ...
    public void toStringOutput() throws IntrospectionException, SecurityException, NoSuchMethodException {
        {
            ...
            assertThat(pd.toString(),
                    containsString("PropertyDescriptor[name=foo, propertyType=null, readMethod=null"));
        }
        {
            class C {
            ...
            assertThat(pd.toString(),
                    allOf(containsString("PropertyDescriptor[name=foo"),
        ...
        }
        {
            ...
            assertThat(pd.toString(),
                    containsString("PropertyDescriptor[name=foo, propertyType=null, indexedPropertyType=null"));
        }
        {
            class C {
                @SuppressWarnings("unused")
            ...
            assertThat(pd.toString(),
                    allOf(containsString("PropertyDescriptor[name=foo, propertyType=null"),
